  ...
  return (
    <div className="relative bg-white">
      <div className="absolute inset-0 w-full h-screen overflow-hidden">
        <video className="w-full h-full object-cover" src="/gradient-video.mp4" loop autoPlay muted/>
        <div 
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between w-full min-h-screen px-6 z-10">
        <div className="w-full md:w-3/4 text-center md:text-left">
          ...
          <h1 className="text-5xl sm:text-7xl md:text-9xl lg:text-[10rem] font-bold mb-4 leading-tight bg-gradient-to-r from-emerald-400 via-teal-400 to-blue-400 text-transparent bg-clip-text drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">SocialHelp</h1>
